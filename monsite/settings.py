...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-8(!3l4r5s&fq0q)om#wgk=%(v755(@5ar^((=mx231us0y#889')
...
STATIC_URL = '/static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles')  # Important pour la production
STATICFILES_DIRS = [
